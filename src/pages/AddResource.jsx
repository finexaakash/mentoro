...
//         className="w-full max-w-md p-8 rounded-2xl bg-white/5 backdrop-blur border border-white/10 shadow-xl"
//       >
...
//           type="submit"
//           disabled={loading}
//           className="w-full py-3 rounded-lg bg-indigo-500 hover:bg-indigo-600 text-white font-semibold"
//         >
...
//   // 🔥 INSTANT LOCK (NO DELAY)
//   const lastSubmitRef = useRef(0);

//   const AUTH_KEY = "auth-cache";
//   const LOCK_KEY = "add-resource-lock";
//   const CACHE_TIME = 10 * 60 * 1000;
//   const COOLDOWN = 10000; // 5 sec
...
//     // 🔒 1. UI LOCK (double click)
//     if (loading) return;

//     // 🔒 2. REF LOCK (instant cooldown)
//     if (now - lastSubmitRef.current < COOLDOWN) {
//       alert("⏳ Please wait a few seconds before submitting again");
//       return;
//     }

//     // 🔒 3. LOCALSTORAGE LOCK (refresh / multi-tab spam)
...
//       // 🔓 AUTO REMOVE LOCK AFTER COOLDOWN
//       setTimeout(() => {
...
//           type="submit"
//           disabled={loading}
//           className="w-full py-3 rounded-lg bg-indigo-500 hover:bg-indigo-600 text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
//         >
//           {loading ? "Saving..." : "Save Resource"}
//         </button>
//       </form>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 text-white">
      <form onSubmit={handleSubmit(submit)} className="w-full max-w-md p-8 bg-white/5 border border-white/10 rounded-xl">
        ...
        {/* <button type="submit" disabled={loading || limitReached} className="w-full py-3 bg-indigo-500 rounded">
